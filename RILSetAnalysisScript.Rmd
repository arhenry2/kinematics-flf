...
* Goodness of fit for flf curve (R^2, optional: show flf on point cloud for each RIL)
...
# Note: The following code chunks are copied from combineResStructures.Rmd
I copied this here to have one Analysis Script, instead of several scripts doing partial work
...
# From here, load the csv files into Excel to correctly place the RILs in order
## There no leading zeros are allowed in QTLCode.R & R won't place them in order without leading zeros...
