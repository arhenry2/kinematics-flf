...
res <- processMasterFolder(masterPath, 2)
...
wholePosVel = read.csv("/Users/ashleyhenry/Desktop/RILPop_tmp/RIL40_1/RILpop--RIL40--RIL40_002_5-- copy/rawData.csv", header = FALSE)
...
maxV = max(REGRtmp) # finds Vmax
per = 0.2 # percentage of area under the curve we want
maxF = max(fittedVel) # finds vf
...
k = which((REGRtmp < maxV*per) & (fittedVel > maxF*0.5)) 
kbool = (REGRtmp < maxV*per) & (fittedVel > maxF*0.5)
plot(kbool)
...
save(res, file = "~/rildata/rildata_realfullDataset/2020_11_19_res_RILPop_full.RData")
...
# Save progress
save(RILParam_concatenated, file = "~/rildata/rildata_realfullDataset/2020_11_20_RILsSummaryParameters.csv")
```
...
AllRILs_SummaryParameters = load("~/rildata/rildata_realfullDataset/2020_11_20_RILsSummaryParameters.csv")
...
write.csv(AllRILs_SummaryParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_SummaryParameters.csv")
```
...
write.csv(AllRILs_nParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_nParameters.csv")
...
write.csv(AllRILs_AveragedParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_AveragedParameters.csv")
write.csv(AllRILs_MedianParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_MedianParameters.csv")
write.csv(AllRILs_StDevParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_StDevParameters.csv")
write.csv(AllRILs_VarianceParameters, "~/rildata/rildata_realfullDataset/2020_11_20_AllRILs_VarianceParameters.csv")
