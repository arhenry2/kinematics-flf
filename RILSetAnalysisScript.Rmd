...
k = which((REGRtmp < maxREGR*per) & (fittedVel > maxVel*0.5)) # reports row number/column number of the cases that are "true"
k
...
# Above won't work well, b/c no values are in the mat zone for RIL40... will leave an NA, see if this will cause issues
# Try again for RIL83 -> found values greater than mat zone start!
percentofMatZone = (length(rawDatainMatZone)/length(res[[3]]$rawData[[1]]$vel))*100
...
### Brain dump:
# RIL1_002_3.5 has 67% of it's rawData vel values. This seems ridiculously high... Where am I making a mistake?
```
...
write.csv(AllRILs_nParameters, "~/rildata/rildata_realfullDataset/2020_12_07_AllRILs_nParameters.csv")
...
write.csv(AllRILs_AveragedParameters, "~/rildata/rildata_realfullDataset/2020_12_07_AllRILs_AveragedParameters.csv")
write.csv(AllRILs_MedianParameters, "~/rildata/rildata_realfullDataset/2020_12_07_AllRILs_MedianParameters.csv")
write.csv(AllRILs_StDevParameters, "~/rildata/rildata_realfullDataset/2020_12_07_AllRILs_StDevParameters.csv")
write.csv(AllRILs_VarianceParameters, "~/rildata/rildata_realfullDataset/2020_12_07_AllRILs_VarianceParameters.csv")
