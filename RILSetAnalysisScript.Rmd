...
save(res, file = "~/rildata/rildata_fullDataset/res_RILsExtras.RData")
...
load("~/rildata/rildata_fullDataset/res_CviLer_RILs1-10.RData")
...
save(RES, file = "~/rildata/rildata_fullDataset/2020_10_08_allresStructures.RData")

load("~/rildata/rildata_fullDataset/2020_10_08_allresStructures.RData")

# Find number of replicates in RES dataset (is it 1640-~25, or 1750?)
...
# Save progress
save(RILParam_concatenated, file = "~/rildata/rildata_fullDataset/2020_10_08_RILsSummaryParameters.csv")
```
...
AllRILs_SummaryParameters = load("~/rildata/rildata_fullDataset/rawRIL.csv")
...
# Added to load in Nathan's version of my data, done on 10-19-2020
AllRILs_SummaryParameters = read.csv("~/rildata/rildata_fullDataset/rawRIL.csv")
# Added to load in Nathan's version of my data, done on 10-19-2020
AllRILs_SummaryParameters$RILs <- AllRILs_SummaryParameters$Row
...
write.csv(AllRILs_SummaryParameters, "~/rildata/rildata_fullDataset/2020_10_19_NATHAN_AllRILs_SummaryParameters.csv")
```
...
AllRILs_SummaryParameters = read.csv("~/rildata/rildata_fullDataset/2020_10_19_NATHAN_AllRILs_SummaryParameters.csv")
...
write.csv(AllRILs_AveragedParameters, "~/rildata/rildata_fullDataset/2020_10_19_NATHAN_AllRILs_AveragedParameters.csv")
write.csv(AllRILs_MedianParameters, "~/rildata/rildata_fullDataset/2020_10_08_AllRILs_MedianParameters.csv")
write.csv(AllRILs_StDevParameters, "~/rildata/rildata_fullDataset/2020_10_08_AllRILs_StDevParameters.csv")
write.csv(AllRILs_VarianceParameters, "~/rildata/rildata_fullDataset/2020_10_08_AllRILs_VarianceParameters.csv")
write.csv(AllRILs_nParameters, "~/rildata/rildata_fullDataset/2020_10_08_AllRILs_nParameters.csv")
```
