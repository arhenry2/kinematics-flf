...
#######################################################################################################################################
## As of 4pm 1-5-2021 Talked w/ Edgar, he said to check if there's a correlation b/w meanAbsDiff values & low % mat zone & matSlope
...
tmp = cbind(WholeRILSet_PercentofMatZone$percentofMatZone, AllRILs_SummaryParameters$meanAbsDiff)
plot(tmp)
...
# Plot to see if there's correlation b/w percentofMatZone & matSlope
## There's a correlation: As the % of points in mat zone increases, so does the slope of the last 10 vel curve points
ggplot(WholeRILSet_PercentofMatZone, aes(x = WholeRILSet_PercentofMatZone$percentofMatZone, AllRILs_SummaryParameters$matSlope)) +
  geom_point() +
  xlab("Percent of Position Points in Maturation Zone") +
  ylab("Slope of Last 10 Velocity Curve Points") +
  ggtitle("") +
  theme_bw()
