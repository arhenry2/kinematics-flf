...
write.csv(AllRILs_AveragedParameters, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021_09_27_AllMutants_AveragedParameters-outliersRemoved.csv")
...
qqplot(abcb19$x0, runif(1000)) # ran for Col, pin2, abcb4, & abcb19 (all mostly follow a N dist)
...
for (i in 1:length(res)) {
  ...
  write.csv(resultVel, paste('/Users/ashleyhenry/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/PosEvaluatedVel', as.numeric(i), '.csv', sep = ""), row.names = F)
  ...
  write.csv(resultREGR, paste('/Users/ashleyhenry/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/PosEvaluatedREGR', as.numeric(i), '.csv', sep = ""), row.names = F)
...
# "abcb19" "b4"     "Col"    "pin2" 
avgVelCurve <- matrix(nrow = length(pos), ncol = 5)
avgVelCurve[,1] <- pos
avgVelCurve[,2] <- flf(pos, avgParameters_Mutants$x0[1], avgParameters_Mutants$vf[1], avgParameters_Mutants$k[1], avgParameters_Mutants$n[1]) 
avgVelCurve[,3] <- flf(pos, avgParameters_Mutants$x0[2], avgParameters_Mutants$vf[2], avgParameters_Mutants$k[2], avgParameters_Mutants$n[2])
avgVelCurve[,4] <- flf(pos, avgParameters_Mutants$x0[3], avgParameters_Mutants$vf[3], avgParameters_Mutants$k[3], avgParameters_Mutants$n[3])
avgVelCurve[,5] <- flf(pos, avgParameters_Mutants$x0[4], avgParameters_Mutants$vf[4], avgParameters_Mutants$k[4], avgParameters_Mutants$n[4])

# Make a dataframe
avgVelCurve = data.frame(avgVelCurve)
# Change column names to pos & genotype
colnames(avgVelCurve) <- c("pos", "abcb19", "abcb4", "Col", "pin2")
# Turn to long format
avgVelCurve_IAAMutants_longForm = melt(avgVelCurve, id.var = "pos")
# Save work
write.csv(avgVelCurve, paste('/Users/ashleyhenry/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021-09-27_avgVelCurve_IAAMutants-withCol.csv'), row.names = F)
...
j'u'lian bustsamane was here.


```{r plotting}
data = read_csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/PosEvaluatedVel1.csv")
data_long = melt(data, id.var = "V1")
ggplot(data_long, aes(x = V1, y = value, color = variable)) +
  geom_point()
