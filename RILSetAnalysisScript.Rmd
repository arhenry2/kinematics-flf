...
save(res, file = "~/rildata/rildata_fullDataset/2020_10_30_res_RILs_full.RData")


##### Use this to check if correct RILs are associated with correct data!!!
### Implemented this 10-26-2020 b/c Nathan's loaded data and my loaded data of the same RIL set are different...
# dataCheck = load("~/rildata/rildata_fullDataset/res_RILs_full.RData")
...
######################################################################
# Note: only use this if you have multiple res structures to combine #
## Don't need now that I have the full RIL set in one res strcuture ##
######################################################################
...
# fils <- matrix(list.files("~/rildata/rildata_fullDataset", pattern = "RData$", full.names = TRUE, recursive = TRUE))
# 
# fils
# 
...
# Save progress
save(RILParam_concatenated, file = "~/rildata/rildata_fullDataset/2020_10_21_RILsSummaryParameters.csv")
```
...
AllRILs_SummaryParameters = load("~/rildata/rildata_fullDataset/2020_10_21_RILsSummaryParameters.csv")
...
write.csv(AllRILs_SummaryParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_SummaryParameters.csv")
```
...
AllRILs_SummaryParameters = read.csv("~/rildata/rildata_fullDataset/2020_10_21_AllRILs_SummaryParameters.csv")
...
write.csv(AllRILs_nParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_nParameters.csv")
...
write.csv(AllRILs_AveragedParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_AveragedParameters.csv")
write.csv(AllRILs_MedianParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_MedianParameters.csv")
write.csv(AllRILs_StDevParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_StDevParameters.csv")
write.csv(AllRILs_VarianceParameters, "~/rildata/rildata_fullDataset/2020_10_21_AllRILs_VarianceParameters.csv")
