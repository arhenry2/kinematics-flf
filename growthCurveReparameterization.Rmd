...
functionName = function(fileName, posVel, posREGR){
 ...
 # Calculate position of maxREGR
    positionMaxREGR = which(fittedREGR == maxREGR)
...
save(growthCurveDescriptors, file = "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021-10-07_growthCurveDescriptors.csv")
```
...
### Added 2021-10-07:
# Same, but for Auxin Transport Mutants now
growthCurveDescriptors$mutants <- growthCurveDescriptors$filename
growthCurveDescriptors$mutants = str_extract(growthCurveDescriptors$mutants, "[A-Z]*[a-z]*[0-9]*")
write.csv(growthCurveDescriptors, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021_10_07_growthCurveDescriptors.csv")
```
...
data = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021_10_07_growthCurveDescriptors.csv")

# Density plots to see distribution of each REGR curve descriptor:
## maxREGR: very Normally distributed!
ggplot(data, aes(maxREGR)) +
  geom_density()
...
ggplot(data, aes(positionMaxREGR)) +
  geom_density()

## growthZoneWidth: mostly normal, skewed right
ggplot(data, aes(growthZoneWidth)) +
  geom_density()
...
AllRILs_SummaryParameters = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021_10_07_growthCurveDescriptors.csv")
...
maxREGR_Col_pin2 = t.test(Col$maxREGR, pin2$maxREGR, var.equal = FALSE) # p-value = 5.323e-06
...
# Plot positionMaxREGRvs growthZoneWidth to see if they're two separate variables
