...
masterPath <- "/Users/ashleyhenry/Box/Henry_Ashley/Shared Kinematics/Elisabeth_CompleteData/Col&Mutants"
...
save(res, file = "res_RILs161-162.RData")
# Loads res into environment
load("/Users/ashleyhenry/Desktop/Research/Kinematics/RCodeForExperiments/res_Elisabeth_Col-IAAMutants.RData")
```
...
write.csv(avgREGRCurve, paste('/Users/ashleyhenry/Desktop/avgREGRCurve_pin2.csv'), row.names = F)

```

```{r plottingPracticeREGRCurves}
abcb4pin2 = read_csv("/Users/ashleyhenry/Desktop/avgREGRCurve_abcb4pin2.csv")
abcb4 = read_csv("/Users/ashleyhenry/Desktop/avgREGRCurve_abcb4.csv")
Col = read_csv("/Users/ashleyhenry/Desktop/avgREGRCurve_Col.csv")
pin2 = read_csv("/Users/ashleyhenry/Desktop/avgREGRCurve_pin2.csv")
