...
##########################################################################
##########################################################################
##### 2020-05-27 Need to add leading zeros...
# Examples from internet
NHOUR <- sprintf("%02d",DB$HOUR) # fix to 2 characters 
tst = sprintf("%03d", AllRILs_SummaryParameters$RILs)
# Examples from internet
a <- seq(1,101,25)
sprintf("RIL_%03d", a) # output: "RIL_001, RIL_026..."

# Try without having RIL in RIL name
AllRILs_SummaryParameters$RILs <- str_extract(AllRILs_SummaryParameters$RILs, "[A-Z]+[0-9]+") 
...
AllRILs_SummaryParameters$RILs <- sprintf("RIL_%03d", as.numeric(AllRILs_SummaryParameters$RILs))
