...
save(res, file = "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-12-06_res_auxinMutants.RData")

# Or if you already did this step:
load("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/2021-12-06_res_auxinMutants.RData")
```
...
load("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-12-06_res_auxinMutants.RData")
...
# Save progress
write.csv(RILParam_concatenated, file = "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-12-06_res_auxinMutants_SummaryParameters.csv")
```
...
IAAMutants_SummaryParameters = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-12-06_res_auxinMutants_SummaryParameters.csv")
...
write.csv(IAAMutants_SummaryParameters, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-12-06_res_auxinMutants_SummaryParameters.csv")
```
...
write.csv(auxinMutants_PercentofMatZone, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles//11--2021_IAAMutants_PercentofMatZone.csv")


auxinMutants_PercentofMatZone = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData/11-19-2021_IAAMutants_PercentofMatZone.csv", header = TRUE) %>%
  select(-X)
...
IAAMutants_SummaryParameters = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-11-22_res_auxinMutants_SummaryParameters.csv") %>%
  select(-X, -X.1) %>%
  group_by(fileName)
# data = cbind(AllRILs_SummaryParameters, WholeRILSet_PercentofMatZone)
data = cbind(IAAMutants_SummaryParameters, auxinMutants_PercentofMatZone)
identical(data[,2], data[,10]) # Check if filename columns are identical -> Yes, they are
...
write.csv(data, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_06_IAAMutants_SummaryParameters-removedLittleMatZoneRoots.csv")
...
data = read.csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_06_IAAMutants_SummaryParameters-removedLittleMatZoneRoots.csv")
data = data %>%
  select(-X, -X.1, -X.2)
...
```{r parameter-distributions-by-mutant-genotype}
# Outlier testing with density plots
IAAMutants_SummaryParameters = read_csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021-11-22_res_auxinMutants_SummaryParameters-wCol.csv")
...
AllMutants_SummaryParameters = read_csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_06_IAAMutants_SummaryParameters-removedLittleMatZoneRoots.csv") %>%
  select(-X, -X.1, -filename, -fileName) %>%
...
write.csv(AllMutants_AveragedParameters, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_09_AllMutants_AveragedParameters.csv")
write.csv(AllMutants_StDevParameters, "~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_09_AllMutants_StDevParameters.csv")
```
...
AllMutants_AvgParameters = read_csv("~/Desktop/AuxinTransportMutants/2020-21_Data/IAAMutants_ProcessedData-wAlleles/2021_12_09_AllMutants_AveragedParameters.csv") %>%
  mutate(x0 = as.numeric(x0),
         vf = as.numeric(vf),
         k = as.numeric(k),
         n = as.numeric(n))
...
write.csv(velCurves_long, "~/Desktop/2021-12-15_velCurves_long.csv")
velCurves_long = read.csv("~/Desktop/2021-12-15_velCurves_long.csv") %>%
  select(-X)
...
write.csv(REGRCurves_long, "~/Desktop/2021-12-15_REGRCurves_long.csv") # manually changed mutant's name to w/out alleles
REGRCurves_long = read.csv("~/Desktop/2021-12-15_REGRCurves_long.csv")
